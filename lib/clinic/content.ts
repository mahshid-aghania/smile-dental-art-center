...
export const NAV_ITEMS = [
  ...
  },
  {
    ...
    children: [
      { label: "Implants Overview", href: "/dental-implants" },
      { label: "Single Tooth Implants", href: "/dental-implants/single-tooth" },
      { label: "All-on-4 Dental Implants", href: "/dental-implants/all-on-4" },
      { label: "Implant-Supported Dentures", href: "/dental-implants/implant-dentures" },
      { label: "Same-Day Implants", href: "/dental-implants/same-day" },
      { label: "Implants vs Dentures", href: "/dental-implants/vs-dentures" },
      { label: "Bone Grafting", href: "/dental-implants/bone-grafting" },
      { label: "Sinus Lift", href: "/dental-implants/sinus-lift" },
      { label: "The Implant Procedure", href: "/dental-implants/procedure" },
      { label: "Implant Cost in Markham", href: "/dental-implants/cost" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Dental Implants in Markham", href: "/blog/dental-implants-markham-cost-process" },
      { label: "Invisalign in Markham", href: "/blog/invisalign-markham-cost-timeline" },
      { label: "Teeth Whitening in Markham", href: "/blog/teeth-whitening-markham-options" },
      { label: "Finding a Family Dentist", href: "/blog/finding-family-dentist-markham" },
      { label: "Dental Emergency: What to Do", href: "/blog/dental-emergency-markham-what-to-do" },
      { label: "New Patient Guide", href: "/blog/new-patient-first-visit-guide" },
    ],
  },
