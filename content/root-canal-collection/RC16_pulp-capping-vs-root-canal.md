---
Article ID: RC16
Primary keyword: pulp capping vs root canal
Secondary keywords: vital pulp therapy; direct pulp cap; can you avoid a root canal; deep filling vs root canal
Search intent: Informational
Slug: pulp-capping-vs-root-canal
Full URL: /blog/pulp-capping-vs-root-canal
SEO title: Pulp Capping vs Root Canal: Can the Nerve Be Saved? | Smile Dental Arts Centre
Meta description: If a cavity is deep, can the dentist protect the nerve instead of doing a root canal? Learn what pulp capping and vital pulp therapy are, and when they work.
...
Every decision here turns on the pulp's condition. Dentists describe pulp inflammation as either **reversible** (irritated but able to heal) or **irreversible** (damaged beyond recovery) — a distinction explained in plain terms in [lingering sensitivity to hot and cold](/blog/lingering-tooth-sensitivity-hot-cold).

- **Reversible** → protecting the pulp may work, so capping is worth considering.
- **Irreversible or dead** → protecting it is not an option; the pulp must be removed with a [root canal](/blog/what-happens-during-a-root-canal).
...
If you have a deep cavity and want to know whether the nerve can be protected rather than removed, we can assess the pulp and give you an honest read on your options. Learn about [root canal treatment in Markham](/root-canal-markham) or [book a check-up](/appointments).
